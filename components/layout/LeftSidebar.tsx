...
export const LeftSidebar: React.FC = () => {
  ...
  const fabricationCategories: { key: string; desc: string }[] = [
    { key: 'spool', desc: 'ISO 도면 기반 스풀 사전제작' },
    { key: 'skid', desc: '단일 프레임 패키지 모듈화' },
    { key: 'structure', desc: '가대·플랫폼 철구조물 가공' },
  ];

  // 견적규모별 카테고리
  const budgetCategories = [
    { value: 'small', range: '≤1,000만' },
    { value: 'medium', range: '1,000만~1억' },
    { value: 'large', range: '>1억' },
    { value: 'unknown', range: '온라인 컨설팅' },
  ];
